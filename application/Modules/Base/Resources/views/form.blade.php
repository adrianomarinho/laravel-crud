...
<div class="container pai" style="margin-top: 5%;">
    ...
    <div class="row">
        <div class="col-md-12">
            <h1 class="text-center text-success"> Página de Registro</h1>
        </div>
    </div>
        ...
        <div class="row">
            <div class="form-group">
                <div class="col-md-2">
                    ...
                    <input name="codigo" value="{{ old('codigo') }}" type="text" class="form-control" id="codigo">
                </div>
                <div class="col-md-8">
                    <label for="nome">Nome</label>
                    <input name="nome" value="{{ old('nome') }}" type="text" class="form-control" id="nome">
                </div>
                <div class="col-md-2">
                    <label for="documento">CPF/CNPJ</label>
                    <input name="documento" value="{{ old('documento') }}" type="text" class="form-control cpfcnpj" id="documento">
                </div>
            </div>
        </div>
        <hr>
        <div class="row">
            <div class="form-group">
                <div class="col-md-2">
                    ...
                    <input name="cep" value="{{ old('cep') }}" type="text" class="form-control cep buscaCep" id="cep">
                </div>
                <div class="col-md-9">
                    <label for="logradouro">Logradouro</label>
                    <input name="logradouro" value="{{ old('logradouro') }}" type="text" class="form-control" id="logradouro">
                </div>
                <div class="col-md-1">
                    <label for="numero">Número</label>
                    <input name="numero" value="{{ old('numero') }}" type="text" class="form-control" id="numero">
                </div>
            </div>
        </div>
        <br>
        <div class="row">
            <div class="form-group">
                <div class="col-md-4">
                    ...
                    <input name="complemento" value="{{ old('complemento') }}" type="text" class="form-control" id="complemento">
                </div>
                <div class="col-md-2">
                    <label for="bairro">Bairro</label>
                    <input name="bairro" value="{{ old('bairro') }}" type="text" class="form-control" id="bairro">
                </div>
                <div class="col-md-5">
                    <label for="cidade">Cidade</label>
                    <input name="cidade" value="{{ old('cidade') }}" type="text" class="form-control" id="cidade">
                </div>
                <div class="col-md-1">
                    <label for="uf">UF</label>
                    <input name="uf" value="{{ old('uf') }}" type="text" class="form-control" id="uf">
                </div>
            </div>
        </div>
        <hr>
        <div class="row">
            <div class="form-group">
                <div class="col-md-4">
                    ...
                    <input name="fone" value="{{ old('fone') }}" type="text" class="form-control telefone" id="telefone">
                </div>
                <div class="col-md-4">
                    <label for="limite">Limide de Crédito</label>
                    <input name="limite" value="{{ old('limite') }}" type="text" class="form-control dinheiro" id="limite">
                </div>
                <div class="col-md-4">
                    <label for="validade">Validade</label>
                    <input name="validade" value="{{ old('validade') }}" type="date" class="form-control data" id="validade">
                </div>
            </div>
        </div>
        <br>
